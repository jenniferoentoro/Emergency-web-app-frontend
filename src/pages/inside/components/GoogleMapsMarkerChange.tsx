...
import { addSingleMarkersCircle } from "./addSingleMarkersCircle";
...
export const GoogleMaps = ({
  ...
  useEffect(() => {
    ...
    if (ref.current) {
      ...
      map.addListener("click", (event: any) => {
        ...
        addSingleMarkersCircle({ locations: [clickedLocation], map });
      });
      ...
      addSingleMarkersCircle({ locations, map });
    }
  ...
  let DEFAULT_ZOOM: number | undefined;
