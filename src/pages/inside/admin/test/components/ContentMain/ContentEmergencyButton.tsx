            ...
            <div className="row justify-content-center">
              <div className="col-12 text-center">
                ...
                <p className="text-xl animate__animated animate__fadeIn">
                  Your current location is: {address.house_number}{" "}
                  {address.road} {address.city} {address.country}
                </p>
                <p className="text-xl animate__animated animate__fadeIn">
                  Press the "Emergency" button 3 times within 3 seconds to
                  proceed:
                </p>
                <button
...
export default ContentEmergencyButton;
