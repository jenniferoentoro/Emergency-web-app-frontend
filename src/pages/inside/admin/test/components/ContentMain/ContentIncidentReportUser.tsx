...
const ContentIncidentReportUser = () => {
          ...
          <div className="container-fluid">
            <div className="row justify-content-center">
              <div className="col-md-12">
                <h1 className="text-center">Incident Report</h1>
              </div>
            </div>
            <div className="row">
              <div className="col-md-12">
                <div className="d-flex justify-content-end align-items-center">
                  <div className="d-flex">
                    <Link to="/incidentreport/upload">
                      <button className="mx-2 px-2 bg-[#BC5C54] text-white">
                        <AddIcon />
                        Upload
                      </button>
                    </Link>
                    <Link to="/incidentreport/history">
                      <button className="bg-[#BC5C54] text-white">
                        <HistoryIcon /> History
                      </button>
                    </Link>
                  </div>
...
export default ContentIncidentReportUser;
